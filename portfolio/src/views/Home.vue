...
<div>
  <div class="content">
    <div class="w-full ">
      ...
      <span>Know me</span>
      <h3> WHO AM I </h3>
      <p> I've been working as a  Web Front end engineer with over 8 years of  experience in the industry and a passion for creating web applications that are focused and easy to use.  My skill set includes UX and API integration.</p>
      <strong>Objectives</strong>
      <p>My Objectives is to help  companies build a platform  using my skills to reach the company goals.</p>
    </div>
  </div>
